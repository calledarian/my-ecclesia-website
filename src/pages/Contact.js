  ...
  return (
    <div className="contact-info">
      ...
      <div className="social-media">
        ...
        <ul>
          <li>
            <a style={{ color: "blue"}} href="https://www.facebook.com/PPbec/" target="_blank" rel="noreferrer">Facebook</a>
          </li>
          <li>
            <a style={{ color: "red"}} href="https://instagram.com/fieldworkers_in_cambodia/" target="_blank" rel="noreferrer">Instagram</a>
          </li>
        </ul>
      </div>
    </div>
